...
function kmiaid_script()
{
  ...
  // wp_enqueue_script( 'gfont-static', 'https://fonts.gstatic.com');
  // wp_enqueue_script( 'gfont-api', 'https://fonts.googleapis.com' );
